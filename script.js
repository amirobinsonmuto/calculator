...
//global functions to be called in to the main functions
...
//add event listener to a point button and store the value in input
    const pointButton = document.querySelector(".point");

    pointButton.addEventListener('click', ()=>{
            
            //if the current input contains a point, do not allow another point to be added it input
            if (!input.includes(".")) {
                input += pointButton.value;
                display.textContent = input;
            } 
        })
